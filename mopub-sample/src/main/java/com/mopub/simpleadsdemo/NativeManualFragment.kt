...
class NativeManualFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adUnitId: String = adConfiguration.adUnitId
        ...
        updateRequestParameters(viewHolder)
        moPubNative = MoPubNative(context!!, adUnitId, object : MoPubNativeNetworkListener {
        ...
        val verizonNativeAdRenderer = VerizonNativeAdRenderer(
            ViewBinder.Builder(R.layout.native_ad_list_item)
                .titleId(R.id.native_title)
                .textId(R.id.native_text)
                .mainImageId(R.id.native_main_image)
